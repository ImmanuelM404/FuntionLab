...
function greeting(newName){
  let sampleString = String(newName)
  console.log("Hello, " + sampleString)
} 
greeting('Jake')
...
function add(num1, num2){
  numString = parseInt(num1)
  num2String = parseInt(num2)
  add = num1 + num2 
  return add
}
let sum = add(4,4)
...
//CODE HERE
function stringFunc(stringL){
return stringL.toUpperCase()
} 
let stringLL = stringFunc(sampleString)
...
let emailCheck2 = emailCheck('   iiiiiiiiiiiiiii@email.com   ')
...
//CODE HERE
// Break down all steps in the instructions 
// 
function compare(a,b){
  return a - b // How would you test logic ?
} 
compare()

function myFunction12 (arr){
  let arrTrueFalse = arr[0] // we want to start loop a lil bit ahead 
...
let arrayIsAscending = myFunction12
console.log(myFunction12(sampleArray))
